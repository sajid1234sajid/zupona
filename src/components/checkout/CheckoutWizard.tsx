...
export default function CheckoutWizard({
  ...
  return (
    <div /* Sampling the reference down the screen gives #fbfdfc at the top
      ...
      className="relative mx-auto flex min-h-screen w-full max-w-md flex-col overflow-hidden bg-gradient-to-b from-white via-brand-mist via-[18%] to-brand-mist tab:max-w-2xl">
      <LeafBackdrop />
