          ...
          <div className="flex items-center justify-between gap-2 pb-2 pt-1">
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <Link href="/wishlist" aria-label="Wishlist" className="relative block">
                ...
                {wishlistCount > 0 && (
                  <span className="absolute -right-1.5 -top-1.5 grid h-[17px] min-w-[17px] place-items-center rounded-full bg-accent-red px-1 text-[10px] font-bold leading-none text-white">
                    {wishlistCount}
                  </span>
                )}
              </Link>
